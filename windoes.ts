...
test('Connect canvas nodes', async ({ browser }) => {
  ...
  await page.goto('https://pavani.console.qa.solpnp.ooguy.com');
  ...
  await page.goto('https://pavani.console.qa.solpnp.ooguy.com/ui/unoagenticaibuilder/agent-creation');
